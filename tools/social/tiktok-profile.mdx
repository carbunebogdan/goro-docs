...
<Note>Use when you want a creator's post history in bulk: tracking a roster of creators, building a content database, or measuring engagement over time. Use tiktok.posts instead when you need its richer per-post field set.</Note>
