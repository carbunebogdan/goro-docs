...
Billed on what the call actually consumes, at roughly **$0.0003 per result** plus our margin. `discover` and `inspect` return a ceiling for your specific request, and you are never charged above it.
