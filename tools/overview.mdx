...
Goro exposes 70 tools: search, social, maps, commerce and people data, plus
...
**Price** is what you pay, all in. Three shapes exist and they do not mean the
same thing, so read the words next to the number.
