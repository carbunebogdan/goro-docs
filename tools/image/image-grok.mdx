...
description: "Generate an original image from a text prompt using xAI Grok Imagine. Returns the URLs of the generated images. Those URLs are temporary: kie.ai deletes generat"
---
