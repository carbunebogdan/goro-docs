...
| `resolution` | `2K`, `4K` |  | Output resolution, and the only thing that changes the price: $0.27 at 2K, $0.36 at 4K. Defaults to 2K. 1K is not offered because this model costs the same at 1K as at 2K, so it would be a smaller image for the same money. Defaults to `"2K"`. |
