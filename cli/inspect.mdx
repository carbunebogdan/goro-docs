...
web.search  Web search
  ...
  price     $0.0075 per page
            ...
            Billed on actual usage, minimum $0.0020.
            The hold scales with what you request. You are charged for what the call
            actually did, and nothing if it cost nothing.
...
fact that billing follows actual usage with a floor, and the note that the hold
is sized from your specific request rather than from the ceiling.
