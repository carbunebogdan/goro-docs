...
`available` is what you can spend right now: cash plus any unexpired included
or promotional credit, minus anything currently held by a running call. That
credit is listed separately when you have some, because it is spent before
cash.
