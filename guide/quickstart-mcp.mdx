...
| Scope | Grants |
| --- | --- |
| `tools:read` | `discover_tools`, `inspect_tool`, `create_upload`, `get_run`, `wallet_balance` |
| `tools:run` | `run_tool` |
...
| `create_upload` | `tools:read` | Before `run_tool`, whenever the tool needs a file the agent holds locally. It spends nothing |
