...
The MCP server exposes eight tools (`discover_tools`, `inspect_tool`,
`create_upload`, `run_tool`, `get_run`, `wallet_balance`,
`remember_tool_choice`, `forget_tool_choice`), each a thin wrapper over the
same code the HTTP endpoints call.
